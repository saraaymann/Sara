...
def get_filters():
    ...
    while True:
        ...
        if city in cities:
            ...
            print("Data only available for chicago, new york city and washington")    
    ...
    while True:
        ...
        day = input("Which day of the week would you like to analyse? ").lower()         
        if day in days:
            break
        else:
            print(" Please enter a valid day ie: Monday")    
...
def user_stats(df,city):
    ...
    # Display earliest, most recent, and most common year of birth
        ...
        print('\nThe oldest user is born on',earliest)
        most_recent= int(df['Birth Year'].max())
        print('The youngest user is born on',most_recent)
